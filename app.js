(function () {
  ...
  const affinityRouteSeeds = {
    "藤田琴音": {
      0: "最初的接触与被选择。状态：仍把自己视作成绩不起眼、实绩不足的底层偶像候补。虽然嘴上会用可爱、吐槽和“我要成为大富豪”的口号撑住场面，但内心不相信自己真的会被认真选择。锚点：打工后的初遇、对制作人身份的怀疑、“这不是搭讪吧”的确认、为什么偏偏选择自己的不安、被制作人看见潜力后的狂喜、将“也许我还有机会”转化成“出人头地，成为大富豪”的第一声宣言。",
